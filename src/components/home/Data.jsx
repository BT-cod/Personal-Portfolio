...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <h3 className="home__subtiitle">Front-End Developer</h3>
        <p className="home__description">I'm creative designer based in Bangalore, and I'm very  passionate and dedicated to my work.</p>
